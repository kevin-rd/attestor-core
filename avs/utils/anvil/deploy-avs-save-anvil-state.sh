...
cd ../../contracts
forge script script/Deployer.s.sol --rpc-url $RPC_URL --private-key $PRIVATE_KEY --verify --verifier blockscout --verifier-url http://devint-scan.mechain.tech/api --broadcast --batch-size 1 -vv
